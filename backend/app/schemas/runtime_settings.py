...
ComputeProvider = Literal["runpod_serverless", "modal_gpu", "huggingface_endpoint", "colab_manual", "local_mock"]
...
class RuntimeSettingsUpdate(BaseModel):
    ...
    compute_provider: ComputeProvider = "runpod_serverless"
    ...
    llm_interpreter_model: str = "gpt-5.5-pro"
    llm_writer_model: str = "gpt-5.5-thinking"
